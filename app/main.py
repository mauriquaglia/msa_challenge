...
mongodb_uri = 'mongodb://' + os.environ.get('DB_HOST', '10.128.0.2') + '/?readPreference=primary&appname=MongoDB%20Compass%20Community&ssl=false'
...
async def root():
    ...
    return {"message": time() - start, "count": counter, "check": os.environ.get('DB_HOST', 'localhost')}
